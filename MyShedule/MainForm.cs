...
namespace MyShedule
{
    public partial class MainForm : Form
    {
        ...
        {
            InitializeComponent();
            dgvShedule.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
            changefont();
        ...
        public void changefont()//call this method
        {

            foreach (DataGridViewColumn c in dgvShedule.Columns)
            {
                c.DefaultCellStyle.Font = new Font("Arial", 14 + 16 * (100 / 1920), GraphicsUnit.Pixel);
            }
        }
        ...
        private void UpdateTableShedule()
        {
                ...
                btnExchangeLessons.Enabled = true;
        ...
        private void tsiExport_Excel_Click(object sender, EventArgs e)
        {
            ...
            if (frmSave.ShowDialog() == DialogResult.OK && frmSave.FileName != "")
            {
                ...
                for (int i = 2; i < EducationAdapter.NamesGroups.Count + 2; i++)
                {
                    ...
                    {
                        sheet[i, j].Value = dgvShedule[oldJ - 1, oldI - 1].Value;
        ...
        {
            dgvShedule.Font = new Font(FontFamily.GenericSansSerif, Screen.PrimaryScreen.Bounds.Height * 9 / 1000);
        }
        ...
        private void dgvShedule_CurrentCellChanged(object sender, EventArgs e)
        {
            if (dgvShedule.ColumnCount >= 0)
            {
                btnExchangeLessons.Enabled = true;
                ...
                btnExchangeLessons.Enabled = false;
            }
        }
    }
}
